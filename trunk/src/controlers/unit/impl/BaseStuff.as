package controlers.unit.impl
{
	...
	public class BaseStuff extends BaseComponent implements IStuffable
	{
		...
		{
			if ( _movie == null )
				_movie = _resource.getMovieClip( _model.symbol );
		...
		{
			unit.model.useStuff( this._model, 1, unit.layer.getUnitByNode(_target).model, _target.row, _target.col );
		...
		public function get stuffModel():StuffModel
		{
			return _model;
		}
