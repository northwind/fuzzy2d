package com.norris.fuzzy.core.sound
{
	...
	[Event(name="sound_start", type="com.norris.fuzzy.core.sound.event.SounderEvent")]
	
	[Event(name="sound_stop", type="com.norris.fuzzy.core.sound.event.SounderEvent")]
	
	[Event(name="sound_end", type="com.norris.fuzzy.core.sound.event.SounderEvent")]
	
	[Event(name="sound_volumn", type="com.norris.fuzzy.core.sound.event.SounderEvent")]
